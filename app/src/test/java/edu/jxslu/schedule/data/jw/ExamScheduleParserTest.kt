...
private object DefaultSlots {
    val value = listOf(
        edu.jxslu.schedule.domain.TimeSlot(1, "08:30", "09:10"),
        edu.jxslu.schedule.domain.TimeSlot(2, "09:15", "09:55"),
        edu.jxslu.schedule.domain.TimeSlot(3, "10:15", "10:55"),
        edu.jxslu.schedule.domain.TimeSlot(4, "11:00", "11:40"),
        edu.jxslu.schedule.domain.TimeSlot(5, "14:00", "14:40"),
        edu.jxslu.schedule.domain.TimeSlot(6, "14:45", "15:25"),
        edu.jxslu.schedule.domain.TimeSlot(7, "15:45", "16:25"),
        edu.jxslu.schedule.domain.TimeSlot(8, "16:30", "17:10"),
        edu.jxslu.schedule.domain.TimeSlot(9, "19:00", "19:40"),
        edu.jxslu.schedule.domain.TimeSlot(10, "19:45", "20:25"),
        edu.jxslu.schedule.domain.TimeSlot(11, "20:30", "21:10"),
    )
}

/** 测试用学期配置：2026-03-02（周一）开学的 20 周学期。 */
private object TermFixture {
    val value = edu.jxslu.schedule.domain.SemesterConfig(
