...
/**
 * 三个桌面条目（2×2 / 2×4 / 4×4）的 receiver（DESIGN §3.6）。
 *
...
open class TodayWidgetTall : TodayWidget()
...
class TodayWidgetReceiverTall : TodayWidgetReceiverBase() {
    override val glanceAppWidget: GlanceAppWidget = TodayWidgetTall()
}
